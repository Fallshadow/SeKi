...
namespace UnityEngine.Animations.Rigging
{
    ...
    public static class RigUtils
    {
        ...
        public static void ExtractAllSyncableData(Animator animator, Rig[] rigs, out List<Transform> syncableTransforms, out List<SyncableProperties> syncableProperties)
        {
